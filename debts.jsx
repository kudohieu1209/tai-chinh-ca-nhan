...
function Debts({ debts, onAddDebt, onDeleteDebt, onSettleDebt }) {
                ...
                <div className={"debt-row" + (isPaid ? " paid" : "")} key={d.id}>
                  ...
                  {isPaid ? (
                    ...
                    <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                      <button className="btn-secondary btn" style={{ padding: "6px 12px", fontSize: 12 }}
                        onClick={() => onSettleDebt && onSettleDebt(d.id)}>
                        {d.type === "owe" ? "Trả" : "Thu"}
                      </button>
